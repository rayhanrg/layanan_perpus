...
<body>
    <nav class="border-gray-50 bg-gray-50 dark:bg-gradient-to-b from-blue-600 to-white dark:border-gray-500">
        ...
        <div class="ring-offset-2 ring-2 ring-offset-slate-50 dark:ring-offset-slate-900 rounded-lg bg-amber-600 shadow-inner grid justify-center mx-10 p-2">
            <p class="text-center ml-5 mb-5 text-base font-semibold text-black dark:text-black">VALIDASI CUTI AKADEMIK ATAU MENGUNDURKAN DIRI</p>            
            <p class="text-justify ml-5 text-base font-normal text-black dark:text-black">LENGKAPI PERSYARATAN CUTI AKADEMIK ATAU MENGUNDURKAN DIRI</p>
            <p class="text-justify ml-5 text-base font-normal text-black dark:text-black">DENGAN MENGUPLOAD SURAT KETERANGAN ATAU PERNYATAAN</p>
        </div>
        <hr class="w-48 h-1 mx-auto my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700">
        <form>
            <div class="grid gap-6 p-5 md:grid-cols-1"> 
                <div>
                    <label for="surat" class="mb-2 text-sm font-medium text-gray-900 dark:text-black">Surat Keterangan Cuti atau Mengundurkan Diri</label>
                </div>
            </div>
            ...
            <div class="flex px-5">
                ...
                <!-- Next Button -->
                <a href="#" class="flex items-center justify-center px-4 h-10 ml-3 text-base font-medium text-white bg-blue-700 border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-amber-400 w-full sm:w-auto py-2.5 text-center dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-blue-800">
                  Next
                </a>
            </div>
        </form>
